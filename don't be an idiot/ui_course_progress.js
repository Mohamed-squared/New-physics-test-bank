...
// NEW: Import function to show course dashboard
...
export function showCourseProgressDetails(courseId = activeCourseId) {
    ...
    // MODIFIED: Ensure correct sidebar is shown
    ...
    <div class="animate-fade-in space-y-6">
         <div class="flex justify-between items-center">
             ...
             <button onclick="window.showCurrentCourseDashboard()" class="btn-secondary-small">
...
async function regenerateCertificatePreview(courseId) {
     ...
     // MODIFIED: Fetch user data to get the definitive display name
     ...
     } catch(e) { console.error("Error fetching user name for certificate:", e); }
