        ...
        <div class="animate-fade-in">
            ...
            <form id="edit-subject-form" onsubmit="window.updateSubject(event, '${id}')" class="space-y-4 content-card">
                 ...
                 <div>
                     ...
                     <input id="edit-mcq-problem-ratio" type="number" min="0" max="100" step="5" value="${(subject.mcqProblemRatio || 0.5) * 100}" required>
                     <p class="form-help-text">Percentage of MCQs in generated tests (0-100%).</p>
                 </div>
                 <div>
                     <label for="edit-default-duration">Default Test Duration (Minutes)</label>
                     <input id="edit-default-duration" type="number" min="5" value="${subject.defaultTestDurationMinutes || 120}" required>
                 </div>
