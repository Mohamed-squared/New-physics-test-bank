...
export const PDF_GENERATION_OPTIONS = {
    ...
    html2canvas: { scale: 2.5, useCORS: true, logging: false, backgroundColor: '#ffffff' }, // Improve quality, allow cross-origin images, set white background
...
// Replaced skipExams with chapterCompletion based on studied chapters
export const GRADING_WEIGHTS = {
    chapterCompletion: 0.20, // 20% based on fraction of chapters marked studied
    assignments: 0.20,       // 20% based on average daily assignment score
    weeklyExams: 0.15,       // 15% based on average weekly exam score
    midcourseExams: 0.20,    // 20% based on average midcourse exam score
    finalExams: 0.20,        // 20% based on average final exam score
    attendance: 0.05,        // 5% based on daily activity (assignment OR chapter study)
    extraPracticeBonusMax: 5,// Max 5 bonus points (added on top of 100)
};
