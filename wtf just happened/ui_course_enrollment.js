...
export async function handlePaceSelection(event, courseId) {
    ...
    if (success) {
        ...
        delete localProgressData.enrollmentDate.FieldValue;
        delete localProgressData.lastActivityDate.FieldValue;
...
// Assign to window scope in script.js (already done)
