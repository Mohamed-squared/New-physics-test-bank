...
export function toggleSelectAllVideos(select) {
...
export function toggleVideoSelection(listItem, videoId, videoTitle) {
...
export function updateSelectionState(videoId, videoTitle, isSelected) {
...
export function updateSelectedVideoCount() {
