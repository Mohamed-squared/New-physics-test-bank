    ...
    if (!currentSubject) {
        displayContent(`
            <div class="text-center p-8 content-card animate-fade-in">
                ...
                <h2 class="text-2xl font-semibold mb-3 text-gray-800 dark:text-gray-200">Welcome, ${currentUser.displayName || 'User'}!</h2>
    ...
    let recentExamsHtml = recentExams.length > 0 ? recentExams.map(exam => {
         ...
         <li class="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-md border dark:border-gray-600 text-sm transition-colors hover:bg-gray-100 dark:hover:bg-gray-600">
             <div class="flex-grow mr-3 overflow-hidden">
                 <span class="font-medium text-gray-800 dark:text-gray-200 truncate block" title="${exam.examId}">${exam.examId.replace('Exam-', '')}</span>
    ...
    <div class="animate-fade-in space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="content-card lg:col-span-1">
                ...
                <p class="text-2xl font-bold text-primary-600 dark:text-primary-400 mb-2">${subjectName}</p>
            ...
            <div class="content-card lg:col-span-2">
                <h3 class="text-lg font-semibold mb-4 border-b pb-2 dark:border-gray-700 text-gray-700 dark:text-gray-300">Quick Actions</h3>
        ...
        <div class="content-card">
             <h3 class="text-lg font-semibold mb-4 border-b pb-2 dark:border-gray-700 text-gray-700 dark:text-gray-300">Recent Exam History</h3>
             <ul class="space-y-3">
                 ${recentExamsHtml}
             </ul>
        </div>
